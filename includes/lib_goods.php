...
{
    $time = gmtime();
    $sql = 'SELECT g.*, c.measure_unit, b.brand_id, b.brand_name AS goods_brand,b.brand_logo,b.age,b.yangzhi_age,b.address, m.type_money AS bonus_money, ' .
