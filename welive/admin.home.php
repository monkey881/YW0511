...
echo '<div><ul>
<li>欢迎您， <u>'.$userinfo['username'].'</u> 进入原味生活客服中心管理面板! 为了确保系统安全, 请在关闭窗口前点击【 <a href="index.php?logout=1" onclick="return confirm(\'确定退出管理面板吗?\');">安全退出</a> 】!</li>
</ul></div>
<BR>
...
<tbody>
	...
	<tr>
		<td>1. 在客服操作面板, 按Esc键: 快速关闭当前访客小窗口.</td>
	</tr>
	<tr>
		<td>2. 在客服操作面板, 按Ctrl + Enter键: 快速提交当前访客小窗口中输入的内容.</td>
	</tr>
	<tr>
		<td>3. 在客服操作面板, 按Ctrl + 下箭头键: 快速最小化访客小窗口.</td>
	</tr>
	<tr>
		<td>4. 在客服操作面板, 按Ctrl + 上箭头键: 快速展开访客小窗口.</td>
	</tr>
	<tr>
		<td>5. 在客服操作面板, 按Ctrl + 左或右箭头键: 快速在展开的访客小窗口中切换.</td>
	</tr>
	<tr>
		<td>6. 在客服操作面板, 点击"挂起"后, 当访客点击当前客服时, 系统将检测是否有同组的, 在线且未挂起的客服, 如果有则自动转接到其他客服(挂起功能相当于忙碌自动转接功能).</td>
	</tr>
</tbody>
</table>';
