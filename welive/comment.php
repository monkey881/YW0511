...
if(isset($_POST['submitcomment'])) {
	...
	if(!$error_c AND !$error_u AND !$error_v){
		...
		if(!$user['userid']){
			...
			$DB->exe("INSERT INTO ".TABLE_PREFIX."comment VALUES(NULL,'$uid','$gname','$content','$phonenum','$email','$qqnum','".GetIP()."','".time()."')");
...
<div id="guest">
	...
	<tr>
	<td><b>手机号码:</b>&nbsp;&nbsp;</td>
	<td style="padding-top:8px;"><input name="phonenum" type="text" size="16" maxlength="48" class="input-text" value="'.$phonenum.'" '. Iif($error_u, ' style="border: 1px solid #FF0000;"') .Iif(isset($_POST['phonenum']), $_POST['phonenum']).'> <span class="red">*</span></td>
	</tr>
	
	<tr>
	<td><b>邮   箱:</b>&nbsp;&nbsp;</td>
	<td style="padding-top:8px;"><input name="email" type="text" size="16" maxlength="48" class="input-text" value="'.$email.'" '. Iif($error_u, ' style="border: 1px solid #FF0000;"') .Iif(isset($_POST['email']), $_POST['email']).'> <span class="red">*</span></td>
	</tr>
	
	<tr>
	<td><b>QQ号码:</b>&nbsp;&nbsp;</td>
	<td style="padding-top:8px;"><input name="qqnum" type="text" size="16" maxlength="48" class="input-text" value="'.$qqnum.'" '. Iif($error_u, ' style="border: 1px solid #FF0000;"') .Iif(isset($_POST['qqnum']), $_POST['qqnum']).'> <span class="red">*</span></td>
	</tr>
	
	<tr>
	<td width="100"><b>'.$lang['content'].':</b></td>
