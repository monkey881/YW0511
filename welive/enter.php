...
<div id="guest">
	<div id="guest_top">
		...
		<div id="guestinfo"><?php echo $welcome_info?> &nbsp;&nbsp;<font color="#11F7EB"><?php echo $username?></font>为您服务</div>
		<div class="timer_div"><span id="timer">00:00</span></div>
	</div>

	<div class="ico_history"><img src="<?php echo $history_imgurl?>"></div>
	<div id="history"><div id="bck-top"></div></div>
	...
	<div id="guest_bottom">
		...
		<div class="copyright" id="copyright"><span style="display:none;"><?php echo COPYRIGHT?></span>© 2013 原味生活在线客服系统</div>
	</div>
</div>
