...
function PrintHeader($username, $where = 'home') {
	...
	<div id="maindiv">
	<div id="header">
	<div id="memu"><a href="admin.home.php" '.Iif($where=='home', 'class="on"').' hidefocus="true">首页</a><!--<a href="admin.settings.php" '.Iif($where=='settings', 'class="on"').' hidefocus="true">设置</a>--><!--<a href="admin.groups.php" '.Iif($where=='groups', 'class="on"').' hidefocus="true">群组</a>--><a href="admin.users.php" '.Iif($where=='users', 'class="on"').' hidefocus="true">客服管理</a><a href="admin.automsg.php" '.Iif($where=='automsg', 'class="on"').' hidefocus="true">常用短语</a><a href="admin.comments.php" '.Iif($where=='comments', 'class="on"').' hidefocus="true">查看客服留言</a><a href="admin.messages.php" '.Iif($where=='messages', 'class="on"').' hidefocus="true">查看客服记录</a><!--<a href="admin.upgrade.php" '.Iif($where=='upgrade', 'class="on"').' hidefocus="true">升级</a>--></div>
...
function PrintFooter() {
	...
	<div id="footer">
	<div class="copyright"><span style="display:none;">' . COPYRIGHT . '</span>© 2013 原味生活在线客服系统&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#top" title="TOP"><img src="'.TURL.'images/btn_top.gif" align="absmiddle" /></a></div>
	</div>
