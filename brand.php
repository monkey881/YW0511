...
function brand_get_goods($brand_id, $cate, $size, $page, $sort, $order)
{
    ...
    /* 获得商品列表 */
    $sql = 'SELECT g.goods_id, g.goods_name, g.market_price,g.goods_weight,g.click_count,g.biaozhun,g.goods_number,b.address,b.brand_name, g.shop_price AS org_price, ' .
