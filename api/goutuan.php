...
header('Pragma: no-cache');
	...
	$sql = "SELECT a.group_id,a.group_name,a.group_image,a.start_time,a.group_need,a.goods_type,a.group_type,a.cat_id,a.is_hdfk,a.already_orders,a.end_time,a.past_time,a.market_price,a.ext_info,a.group_desc ,a.goods_comment,a.city_id,b.suppliers_name,b.west_way,b.east_way,b.phone,b.address " .
    ...
    while ($group_buy = $GLOBALS['db']->fetchRow($res))
	{
        ...
        $xml .= '<lng>'.$group_buy['west_way'].'</lng>';
        $xml .= '<lat>'.$group_buy['east_way'].'</lat>';
        $xml .= '</shop>';
        $xml .= '</shops></data></url>';
	}
	$xml .= '</urlset>';
