...
header('Pragma: no-cache');
	$sql = "SELECT a.group_id,a.group_name,a.group_image,a.start_time,a.group_need,a.is_hdfk,a.already_orders,a.end_time,a.market_price,a.ext_info,a.city_id,a.group_keywords,a.group_desc,a.group_type,b.suppliers_name,b.suppliers_site,b.phone,b.west_way,b.east_way,b.address " .
    ...
    while ($group_buy = $GLOBALS['db']->fetchRow($res))
	{
		...
		$city = $db->getRow($sql);
          ...
          $xml .= '<startline>'. $group_buy['start_time'] .'</startline>';
          $xml .=  '<deadline>'. $group_buy['end_time'] .'</deadline>';
