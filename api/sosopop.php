...
header('Pragma: no-cache');
	...
	$sql = "SELECT a.group_id,a.group_name,a.group_image,a.start_time,a.group_need,a.cat_id,a.is_hdfk,a.already_orders,a.end_time,a.market_price,a.ext_info,a.city_id,a.upper_orders,a.lower_orders,a.group_desc,b.suppliers_name,b.suppliers_site,b.phone,b.address " .
    ...
    while ($group_buy = $GLOBALS['db']->fetchRow($res))
	{
		...
		$city = $db->getRow($sql);	
		 ...
		 $xml .= '<maxQuota>10000</maxQuota>';
		 $xml .= '<minQuota>10</minQuota>';
		 $xml .= '<priority>0</priority>';
		 $xml .= '<merchantEndTime></merchantEndTime></display><shops><shop>';
         $xml .= '<name>'.$group_buy['suppliers_name'].'</name>';
		 $xml .= '<tel>'.$group_buy['phone'].'</tel>';
         $xml .= '<addr></addr><area></area><longitude></longitude><latitude></latitude></shop></shops></data></url>';
