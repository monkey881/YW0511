...
{ /*{{{*/
    public $http_code; 
    public $url; 
    public $server_domain="api.tuan.2345.com";
    public $host = null;
    public $timeout = 10; 
    ...
    public $http_info; 
    public $useragent = 'Tuan2345Auth v1.0.0.1 '; 
...
//        var_dump($request);
        ...
        { 
        case 'GET': 
           //echo $request->to_url(); die('xiongxiaoming');
